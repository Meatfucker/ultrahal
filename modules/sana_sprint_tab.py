...
class SanaSprintRequest:
    ...
    async def generate(self):
        ...
        try:
            base64_images = await self.avernus_client.sana_sprint_image(self.enhanced_prompt, **kwargs)
