...
class SD15InpaintTab(QWidget):
    ...
    async def on_submit(self):
        ...
        try:
            request = SD15InpaintRequest(avernus_client=self.avernus_client,
            ...
            print(f"SD15 INPAINT on_submit EXCEPTION: {e}")
...
class SD15InpaintRequest:
    ...
    async def generate(self):
        ...
        print(f"SD15 INPAINT: {self.prompt}, {self.negative_prompt}, {self.steps}, {self.batch_size}")
